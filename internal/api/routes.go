...
func SetupRoutes(router *gin.Engine, ts utils.TokenService, userService services.UserService, adminService services.AdminService) {
	...
	adminRoutes.GET("/supersets", adminController.GetSupersets)
	...
	// StandAlone Workout Items
	userRoutes.GET("/workout-plans/daily-standalone-workouts/:standaloneId", userController.GetDailyStandAloneWorkoutItemByID)
	userRoutes.POST("/workout-plans/daily-standalone-workouts", userController.GetDailyStandAloneWorkoutItemsByIDs)
	// Supersets
	...
	// Sets 
	userRoutes.GET("/workout-plans/daily-sets/:setId", userController.GetDailySetByID)
	userRoutes.POST("/workout-plans/daily-sets", userController.GetDailySetsByIDs)
