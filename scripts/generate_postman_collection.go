...
func main() {
	...
	routes := []Route{
		...
		{
			Name:        "Create Standalone Workout Item",
			Method:      "POST",
			Path:		 "/api/v1/admin/standalone-workouts",
			Description: "Create a new standalone workout item",
			Headers: []RouteHeader{
				{
					Key:   "Content-Type",
					Value: "application/json",
		...
		{
			Name:        "Update Standalone Workout Item",
			Method:      "PUT",
			Path: 	  	 "/api/v1/admin/standalone-workouts/:id",
			Description: "Update an existing standalone workout item",
			Headers: []RouteHeader{
				{
					Key:   "Content-Type",
					Value: "application/json",
		...
		{
			Name:        "Get Standalone Workout Items",
			Method:      "GET",
			Path: 	  	 "/api/v1/admin/standalone-workouts",
			Description: "Get all standalone workout items",
			Headers: []RouteHeader{
				{
					Key:   "Content-Type",
					Value: "application/json",
		...
		{
			Name:       "Get Standard Workout Plan",
			Method:     "GET",
			Path: 	 	"/api/v1/user/workout-plans/standard",
			Description: "Get the user's standard workout plan",
			Headers: []RouteHeader{
				{
					Key:  "Content-Type",
					Value: "application/json",
		...
		{
			Name: 	 	 "Get Active Exercise Status",
			Method: 	 "GET",
			Path: 	 	 "/api/v1/user/exercises/:exerciseId",
			Description: "Get the active exercise status",
			Headers: []RouteHeader{
				{
					Key:  "Content-Type",
					Value: "application/json",
		...
		},
		{
			...
			Description: "Get the daily set by its ID",
			Headers: []RouteHeader{
				{
					Key:  "Content-Type",
					Value: "application/json",
		...
		{
			Name:       "Get Daily Sets by IDs",
			Method:     "POST",
			Path: 	 	"/api/v1/user/workout-plans/daily-sets",
			Description: "Get the daily sets by IDs sent in the request body",
			Headers: []RouteHeader{
				{
					Key:  "Content-Type",
					Value: "application/json",
...
func createPostmanItemFromRoute(route Route) PostmanItem {
	...
	routePath = strings.Replace(routePath, "workouts/:id", "workouts/{{standAloneWorkoutItemId}}", -1)
